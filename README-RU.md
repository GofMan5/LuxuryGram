...
Приложение обновляется само: оно проверяет этот репозиторий на наличие новой версии и сверяет подпись обновления ключом LuxuryGram до распаковки. Цифровой подписи исполняемых файлов нет, поэтому Windows SmartScreen может предупредить при первом запуске.
