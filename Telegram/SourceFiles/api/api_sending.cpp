...
[[nodiscard]] ConfirmedLocalFile PrepareConfirmedLocalFile(
	...
	// LuxuryGram: has to run before the caption is built below and before
	// convertTopicReplyToId rewrites replyTo, because it moves a deleted
	// reply into the caption and then drops the reply itself.
	if (!isEditing
