...
const std::pair<const char *, const char *> kRussianSettingsStrings[] = {
	{ "luxury_AppIconHeader", "?????? ??????????" },
	{ "luxury_AvatarCorners", "???? ????????" },
	{ "luxury_AvatarCornersCircle", "???????" },
	{ "luxury_AvatarCornersSquare", "??????????" },
	{ "luxury_CategoriesHeader", "?????????" },
	{ "luxury_CategoryAppearance", "??????? ???" },
	{ "luxury_CategoryChats", "????" },
	{ "luxury_CategoryFilters", "???????" },
	{ "luxury_CategoryGeneral", "?????" },
	{ "luxury_CategoryOther", "??????" },
	{ "luxury_ChannelBottomButton", "?????? ?????? ??????" },
	{ "luxury_ChannelBottomButtonDiscuss", "????????" },
	{ "luxury_ChannelBottomButtonHide", "??????" },
	{ "luxury_ChannelBottomButtonMute", "??? ?????" },
	{ "luxury_ChatFoldersHeader", "????? ?????" },
	{ "luxury_CollapseSimilarChannels", "??????????? ??????? ??????" },
	{ "luxury_ConfirmationsTitle", "????????????? ????????" },
	{ "luxury_ContextHideMessage", "??????" },
	{ "luxury_ContextMenuElementsHeader", "???????? ???????????? ????" },
	{ "luxury_CrashReporting", "?????? ? ????????" },
	{ "luxury_CrashReportingDescription", "???? ????? ????????, ????? ??????? ?????????? ????? ?????????? ????????? ?????. ??????? ?? ????." },
	{ "luxury_DeletedMarkText", "??????? ?????????" },
	{ "luxury_DisableAds", "????????? ???????" },
	{ "luxury_DisableChatSelectionLimit", "??? ?????? ?????????" },
	{ "luxury_DisableCustomBackgrounds", "????????? ???? ????" },
	{ "luxury_DisableGreetingSticker", "????????? ?????????????? ??????" },
	{ "luxury_DisableNotificationsDelay", "????????? ???????? ???????????" },
	{ "luxury_DisableOpenLinkWarning", "????????? ?????????????? ? ???????" },
	{ "luxury_DisableSimilarChannels", "????????? ??????? ??????" },
	{ "luxury_DisableStories", "????????? ???????" },
	{ "luxury_DontReadMessages", "?? ?????? ?????????" },
	{ "luxury_DontReadStories", "?? ?????? ???????" },
	{ "luxury_DontSendOnlinePackets", "?? ?????????? ??????" },
	{ "luxury_DontSendUploadProgress", "?? ?????????? ????? ??????" },
	{ "luxury_DrawerElementsHeader", "???????? ??????" },
	{ "luxury_EditedMarkText", "??????? ?????????" },
	{ "luxury_EditsHistoryMenuText", "???????" },
	{ "luxury_EnableGhostModeTray", "???????? ????-?????" },
	{ "luxury_EnableStreamerModeTray", "???????? ????? ????????" },
	{ "luxury_ExpireMediaContextMenuText", "?????" },
	{ "luxury_ExtraHeader", "Luxury Extra" },
	{ "luxury_FilterZalgo", "??????????? ?????" },
	{ "luxury_FiltersClearPopupActionText", "????????" },
	{ "luxury_FiltersClearPopupText", "??????? ??? ????????" },
	{ "luxury_FiltersHideFromBlocked", "???????? ?? ???????????????" },
	{ "luxury_FiltersMenuClear", "????????" },
	{ "luxury_FiltersMenuExport", "???????" },
	{ "luxury_FiltersMenuImport", "??????" },
	{ "luxury_FiltersMenuSelectChat", "??????? ???" },
	{ "luxury_FiltersShadowBan", "??????? ???" },
	{ "luxury_FontDefault", "?? ?????????" },
	{ "luxury_GIFConfirmation", "GIF" },
	{ "luxury_GhostEssentialsHeader", "??????? ??? ?????" },
	{ "luxury_GhostModeGlobalSettings", "????? ?????????" },
	{ "luxury_GhostModeOptionShiftDescription", "???? ? SHIFT ?? ????? ???????? ?? ????? ??? ???????????? ????-??????." },
	{ "luxury_GhostModeSwitchedToGlobalSettings", "?????? ????????? ??? ???? ?????????." },
	{ "luxury_GhostModeSwitchedToIndividualSettings", "????????? ????????? ??? ??????? ????????." },
	{ "luxury_GhostModeToggle", "????-?????" },
	{ "luxury_HideAllChats", "?????? ??????? «??? ????»" },
	{ "luxury_HideNotificationBadge", "?????? ????? ???????????" },
	{ "luxury_HideNotificationBadgeDescription", "???????? ??????? ??????????? ?? ?????? ? ?????? ????? ? ????." },
	{ "luxury_HideNotificationCounters", "?????? ???????? ???????????" },
	{ "luxury_HidePremiumStatuses", "?????? ???????-???????" },
	{ "luxury_HideReactions", "?????? ???????" },
	{ "luxury_HideReactionsInChannels", "??????" },
	{ "luxury_HideReactionsInGroups", "??????" },
	{ "luxury_HideReactionsInPrivateChats", "?????? ????" },
	{ "luxury_HideShareButton", "?????? ??????? ?????? «??????????»" },
	{ "luxury_HideSimilarChannelsTab", "?????? ??????? ??????? ???????" },
	{ "luxury_ImproveLinkPreviews", "???????? ?????? ??????" },
	{ "luxury_LReadMessages", "?????? ????????" },
	{ "luxury_LinksChannel", "?????" },
	{ "luxury_LinksChats", "????" },
	{ "luxury_LinksDocumentation", "????????????" },
	{ "luxury_LinksHeader", "??????" },
	{ "luxury_LinksTranslate", "???????" },
	{ "luxury_LocalPremium", "????????? Telegram Premium" },
	{ "luxury_LuxuryPreferences", "????????? LuxuryGram" },
	{ "luxury_MarkReadAfterAction", "?????? ??? ????????" },
	{ "luxury_MarkReadAfterActionDescription", "????????????? ???????? ????????? ???????????, ????? ?? ??????????? ????? ??? ??????? ???????." },
	{ "luxury_MaterialSwitches", "????? ?????????????? MD3" },
	{ "luxury_MessageBubbleRadius", "?????? ???????? ?????????" },
	{ "luxury_MessageDetailsPC", "??????" },
	{ "luxury_MessageFieldElementAttach", "????????" },
	{ "luxury_MessageFieldElementCommands", "???????" },
	{ "luxury_MessageFieldElementEmoji", "??????" },
	{ "luxury_MessageFieldElementTTL", "TTL" },
	{ "luxury_MessageFieldElementVoice", "?????" },
	{ "luxury_MessageFieldElementsHeader", "???????? ???? ?????" },
	{ "luxury_MessageFieldPopupsHeader", "?????????? ???? ?????" },
	{ "luxury_MessageSavingOtherHeader", "??????" },
	{ "luxury_MessageSavingSaveForBots", "????????? ? ????? ? ??????" },
	{ "luxury_MonospaceFont", "???????????? ?????" },
	{ "luxury_QuickAdminShortcuts", "??????? ?????-??????" },
	{ "luxury_ReadUntilMenuText", "????????? ?????????" },
	{ "luxury_RegexFilterQuickAdd", "???????? ??????" },
	{ "luxury_RegexFilters", "??????? ?????????" },
	{ "luxury_RegexFiltersEnable", "???????? ???????" },
	{ "luxury_RegexFiltersEnableSharedInChats", "????? ??????? ? ?????" },
	{ "luxury_RegexFiltersShared", "????? ???????" },
	{ "luxury_RegisterURLScheme", "???????????????? URL-?????" },
	{ "luxury_RemoveMessageTail", "??????? ????? ?????????" },
	{ "luxury_RepeatMessage", "????????? ?????????" },
	{ "luxury_ReplaceMarksWithIcons", "???????? ?? ??????" },
	{ "luxury_ResetSettings", "???????? ?????????" },
	{ "luxury_ResetSettingsConfirmation", "???????? **???** ????????? LuxuryGram ? ????????? ?? ??????????" },
	{ "luxury_RoundConfirmation", "??????? ?????" },
	{ "luxury_SReadMessages", "?????? ?? ???????" },
	{ "luxury_SaveDeletedMessages", "????????? ?????????" },
	{ "luxury_SaveDeletedMessagesEvenWhenLocked", "????????? ??? ???????" },
	{ "luxury_SaveMessagesHistory", "????????? ??????? ??????" },
	{ "luxury_SemiTransparentDeletedMessages", "?????????????? ?????????" },
	{ "luxury_SendOfflinePacketAfterOnline", "??????? ? ?????? ?????????????" },
	{ "luxury_SendWithoutSoundByDefault", "?????????? ??? ?????" },
	{ "luxury_SendWithoutSoundByDefaultAlways", "??????" },
	{ "luxury_SendWithoutSoundByDefaultDescription", "????????? ????????? ?? ????????? ???????????? ??? ?????." },
	{ "luxury_SendWithoutSoundByDefaultInGhostMode", "? ????-??????" },
	{ "luxury_SendWithoutSoundByDefaultNever", "???????" },
	{ "luxury_SettingsBiggerWindow", "??????? ????" },
	{ "luxury_SettingsContextMenuDescription", "??????????? ?????? ???????????? ??? ?????? ????? ? ???????? CTRL ??? SHIFT." },
	{ "luxury_SettingsContextMenuItemExtended", "??????????? ????" },
	{ "luxury_SettingsContextMenuItemHidden", "??????" },
	{ "luxury_SettingsContextMenuItemShown", "????????" },
	{ "luxury_SettingsContextMenuReactionsPanel", "?????? ???????" },
	{ "luxury_SettingsContextMenuTitle", "????? ?????????? ?????" },
	{ "luxury_SettingsContextMenuViewsPanel", "?????? ??????????" },
	{ "luxury_SettingsDescription", "???? Telegram Desktop ? ???????? ?? ???????????? ? ??????? ?? ?????? ToS." },
	{ "luxury_SettingsIncreaseWebviewHeight", "????????? ?????? ????????" },
	{ "luxury_SettingsIncreaseWebviewWidth", "????????? ?????? ????????" },
	{ "luxury_SettingsShowID", "?????????? ID" },
	{ "luxury_SettingsShowID_Hide", "??????" },
	{ "luxury_SettingsShowLastSeenSeconds", "?????????? ??????? ???????" },
	{ "luxury_SettingsShowMessageSeconds", "?????????? ??????? ?????????" },
	{ "luxury_SettingsShowMessageShot", "?????? ?????????" },
	{ "luxury_SettingsShowMessageShotDescription", "????????? ?????? ?????? ????????? ?????????." },
	{ "luxury_SettingsSpoofWebviewAsAndroid", "???????????? Android" },
	{ "luxury_SettingsUnlimitedRecentStickers", "?????????????? ???????? ???????" },
	{ "luxury_SettingsWideMultiplier", "????????? ?????? ?????????" },
	{ "luxury_SettingsWideMultiplierDescription", "??????? ?????? ????????? ??? ??????? ?????????." },
	{ "luxury_ShowOnlyAddedEmojisAndStickers", "?????? ??????????? ?????? ? ???????" },
	{ "luxury_SimpleQuotesAndReplies", "????????? ??????? ??????" },
	{ "luxury_SingleCornerRadius", "?????? ?????? ?????" },
	{ "luxury_SingleCornerRadiusDescription", "? ??????? ????? ?? ?? ????? ????????, ??? ? ?????." },
	{ "luxury_SpyEssentialsHeader", "??????? ??? ??????" },
	{ "luxury_StickerConfirmation", "???????" },
	{ "luxury_StreamerModeToggle", "????? ????????" },
	{ "luxury_SuggestGhostModeBeforeViewingStory", "?????????????? ????? ????????" },
	{ "luxury_SuggestGhostModeBeforeViewingStoryDescription", "?????????? ?????????????? ????? ????????? ??????? ? ???????????? ???????? ????-?????." },
	{ "luxury_TrackOnlineEvenWhenLocked", "??????? ??? ???????" },
	{ "luxury_TrackOnlineHistory", "??????? ?? ????????" },
	{ "luxury_TranslationProvider", "????????? ????????" },
	{ "luxury_TrayElementsHeader", "???????? ????" },
	{ "luxury_UseScheduledMessages", "??????????? ?????????" },
	{ "luxury_UseScheduledMessagesDescription", "????????????? ??????????? ????????? ???????? ?? 12 ?????? (????? — ??????). ? ???? ???????? ?? ?? ??????????? ? ????.\\n?? ??????????? ?? ???????????? ????." },
	{ "luxury_UserMessagesMenuText", "????????? ????????????" },
	{ "luxury_VoiceConfirmation", "????????? ?????????" },
	{ "luxury_WatchChatsHeader", "????????????? ????" },
};
