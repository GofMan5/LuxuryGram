...
, _autoLockTimer([=] { checkAutoLock(); }) {
	...
	// LuxuryGram: upstream also hooks activeSessionChanges up to
	// UpdateChecker::setMtproto here. We removed the MTP updater path -- our
	// updates come from GitHub releases -- so there is nothing to wire.
...
QString Application::changelogLink() const {
	return u"https://github.com/GofMan5/LuxuryGram/releases"_q;
}
